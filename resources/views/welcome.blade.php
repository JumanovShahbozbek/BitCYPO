    ...
    <div class="wallet">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div id="wa_hover" class="wallet_box text_align_center">
                        <i><img src="/assets/images/wa4.svg" alt="#"/></i>
                        <h3>COIN MINING</h3>
                        <p>It is a long established fact that a reader will be distracted by </p>
                    </div>
                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="growth text_align_center">
                                            <figure>
                                                ...
                                                <img class="img_responsive" src="/assets/images/graf1.jpg" alt="#" />
                                            </figure>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="growth text_align_center">
                                            ...
                                            <figure><img class="img_responsive" src="/assets/images/graf2.jpg" alt="#" /></figure>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="works_vedio">
                        <figure><img class="img_responsive" src="/assets/images/work.png" alt="#"></figure>
                    </div>
                </div>
            </div>
        </div>
